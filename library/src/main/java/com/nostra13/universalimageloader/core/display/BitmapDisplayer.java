...
public interface BitmapDisplayer {
    public static final int FILE_TYPE_UNDEFINE = 1;//未确定文件类型
    public static final int FILE_TYPE_NORMAL_IMAGE = 2;//png或jpeg普通格式图片
    public static final int FILE_TYPE_GIF_IMAGE = 3;//gif格式图片
    /**
